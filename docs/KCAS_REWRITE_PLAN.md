...
- `src\KCAS.Admin\Data\Migrations\kcas_blazor_schema.sql` includes the proportional RMCP control foundation and records latest migration `20260726164754_AddRmcpControlFoundation`.
