...
- `src\KCAS.Admin\Data\Migrations\kcas_blazor_schema.sql` includes the proportional Business Risk Assessment foundation and records latest migration `20260726141855_AddBusinessRiskAssessmentFoundation`.
